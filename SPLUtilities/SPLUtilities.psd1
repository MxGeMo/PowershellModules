#
# Modulmanifest für das Modul "SPLUtilities"
#
# Generiert von: max
#
# Generiert am: 24.08.2018
#

@{

# Die diesem Manifest zugeordnete Skript- oder Binärmoduldatei.
RootModule = 'SPLUtilities.psm1'
...
GUID = 'c33f4dfa-83f7-46cf-aa26-61ed95d88b62'
...
Copyright = '(c) 2018 MXGEMO. Alle Rechte vorbehalten.'

# Beschreibung der von diesem Modul bereitgestellten Funktionen
Description = 'Functions '

# Die für dieses Modul mindestens erforderliche Version des Windows PowerShell-Moduls
# PowerShellVersion = 'to maintain Sharepoint Lists'
...
RequiredModules = @(
    @{ModuleName = 'MyPsTools'; ModuleVersion = '1.0'; }
    )
...
FunctionsToExport = @(
    'Convert-SPLFieldName',
    'Connect-SPSite',
    'Open-SPSite',
    'Open-SPLListsConfig',
    'Get-OraName',
    'Get-SPSite',
    'Get-SPLExcludeFields',
	'Get-SPLListsConfigPath',
	'Get-SPLListsConfig',
    'Read-SPLListsFields',
    'Show-SPLListsFields',
    'Get-SPLListFields',
